...
export class Convert {
    public static toStarshipsResponse(json: string): StarshipsResponse {
        return cast(JSON.parse(json), r("StarshipsResponse"));
    }

    public static starshipsResponseToJson(value: StarshipsResponse): string {
        return JSON.stringify(uncast(value, r("StarshipsResponse")), null, 2);
    }
}
