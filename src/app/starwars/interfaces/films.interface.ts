...
export class Convert {
    public static toFilmsResponse(json: string): FilmsResponse {
        return cast(JSON.parse(json), r("FilmsResponse"));
    }

    public static filmsResponseToJson(value: FilmsResponse): string {
        return JSON.stringify(uncast(value, r("FilmsResponse")), null, 2);
    }
}
