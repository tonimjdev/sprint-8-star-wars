...
export class Convert {
    public static toPilotsResponse(json: string): PilotsResponse {
        return cast(JSON.parse(json), r("PilotsResponse"));
    }

    public static pilotsResponseToJson(value: PilotsResponse): string {
        return JSON.stringify(uncast(value, r("PilotsResponse")), null, 2);
    }
}
